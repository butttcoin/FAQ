...
It is a revolutionary project that will change the way we look at the cryptocurrencies. We cannot say more than that, other than 0xBUTT is a part of a team, and will be appying the same methods for distributing the tokens to a community.
